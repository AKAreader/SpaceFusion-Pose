...
def main():
    ...
    train_ds = PoseDataset(
        ...
        train=True,
        roi_expand=args.roi_expand,  # 例如 1.3
        roi_jitter=args.roi_jitter,  # 例如 0.08~0.12
    ...
    val_ds = PoseDataset(
        ...
        out_size=args.out_size,
        train=False,
        roi_expand=args.roi_expand,  # 评估固定 1.3
        roi_jitter=0.0,
    ...
    for epoch in range(args.epochs):
        ...
        val_loss, mean_deg, med_deg, p90_deg = evaluate(model, val_loader, device)
